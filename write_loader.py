...
# Write data_loader.py directly — no escape confusion
path = os.path.join("src", "ingestion", "data_loader.py")
...
methods = ["load_all","load_support_tickets","load_faq_data",
           "load_ecommerce_intents","_clean_text","_is_meaningful","save_processed"]
print("\nMethod check:")
for m in methods:
    status = "[OK]" if f"def {m}" in content else "[MISSING]"
    print(f"  {status}  {m}")